...
def parsing():
    parser = ap.ArgumentParser(
        prog='prediction prog',
        description='prediction from dataframe with no labels'
    )
    parser.add_argument('-EURUSD', type=str, help='EURUSD data file')
    parser.add_argument('-lifespan', type=int, default=120, help='lifespan of the trade in minutes')
    parser.add_argument('-risk', type=float, default=1, help='percentage of capital for the stop_loss')
    parser.add_argument('-profit', type=float, default=3, help='percentage of capital for the take_profit')
    parser.add_argument('-atr', type=int, default=120, help='periods used for calculating EMA')
    parser.add_argument('-ema', type=int, default=120, help='periods used for calculating EMA')
    ...
    parser.add_argument('-sma', type=int, default=60, help='periods used for calculating SMA')
